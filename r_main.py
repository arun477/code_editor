...
def create_runnable_scripts(code, problem):
    exec_script = templates.get_template('execution_script_v2.jinja2').render(validation_func=problem)
    solution_script = templates.get_template('user_code_template.jinja2').render(user_code=code)
